...
<?php   elseif($projectsEnvolved > 0): ?>
        <div class="alert alert-danger">
                <strong>Operation Failed</strong>.This item is linked whit active projects.</div>
<?php  else: ?>
	<div class="alert alert-warning">Are you sure you want to delete this item?</div>
	<?php  $form = ActiveForm::begin(['id' => 'itemForm']); ?>
		<div style="display:none;">
			<?php  $form->field($model, 'ResearchStationId')->hiddenInput() ?>
		</div>
